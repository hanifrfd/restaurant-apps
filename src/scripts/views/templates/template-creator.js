...
const createFavdButtonTemplates = () => `
    <button aria-label="unfavorite this restaurant" id="favorite" class="unfavorite-btn">
        Unfavorite
    </button>
`;
...
const createLoader = () => `
    <div id="loading">
        <img class="lazyload" src="/loader.gif" width="100" height="100" alt="loader"/>
    </div>
`;
...
export {
  ...
  createFavButtonTemplates,
  createFavdButtonTemplates,
  reviewTemplate,
  formReviewTemplate,
  createLoader,
};
